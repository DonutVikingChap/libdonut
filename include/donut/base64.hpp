 ...
 *
 * \throw std::length_error if the length of the encoded string exceeds the
 ...
 *
 * \throw std::invalid_argument if the length of the Base64 string is not
 *        divisible by 4.
 * \throw std::length_error if the length of the decoded byte sequence exceeds
